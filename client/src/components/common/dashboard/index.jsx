    ...
    return (
      <div style={styles.container}>
        <Jumbotron>
          ...
          <p className="lead">
            This App is a support tool, provided for reference only.
          </p>
          <hr className="my-2" />
          <p>
            It is your responsability to ensure you are using the most up to
            date version of this application.
          </p>
